...
from lstm.networks.training import report_accuracy
from lstm.data.tf_records import read_tfrecord_and_decode_into_image_annotation_pair_tensors
...
class SolverWrapper(object):
    ...
    def mergeLabel(self,labels,ignore = 0):
        ...
        for l in labels:
            ...
            label_lst.append(l)
        targets = [np.asarray(i) for i in label_lst]
        return self.sparse_tuple_from(targets)     
